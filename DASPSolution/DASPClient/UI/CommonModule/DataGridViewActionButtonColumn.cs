...
namespace DASPClient.UI.CommonModule
{
    ...
    public class DataGridViewActionButtonCell : DataGridViewButtonCell
    {
        ...
        private static Image ImageModify = ResourceDynamicReaderUtils.DynamicLoadResourceByResourceName("BtnModify.png"); // 修改按钮背景图片
        private static Image ImageDelete = ResourceDynamicReaderUtils.DynamicLoadResourceByResourceName("BtnDelete.png"); // 删除按钮背景图片
        ...
        private Rectangle PrivatePaint(Graphics graphics, Rectangle cellBounds, int rowIndex, DataGridViewCellStyle cellStyle, bool clearBackground)
        {
            ...
            {
                ImageModify = ResourceDynamicReaderUtils.DynamicLoadResourceByResourceName("BtnModify02.png");
                penModify = new Pen(Color.FromArgb(162, 144, 77));
            }
            else
            {
                ImageModify = ResourceDynamicReaderUtils.DynamicLoadResourceByResourceName("BtnModify.png");
                penModify = new Pen(Color.FromArgb(135, 163, 193));
            }

            if (mouseOnDeleteButton) // 鼠标移动到删除按钮上，更换背景及边框颜色
            {
                ImageDelete = ResourceDynamicReaderUtils.DynamicLoadResourceByResourceName("BtnDelete02.png");
                penDelete = new Pen(Color.FromArgb(162, 144, 77));
            }
            else
            {
                ImageDelete = ResourceDynamicReaderUtils.DynamicLoadResourceByResourceName("BtnDelete.png");
        ...
        public static bool IsModifyButtonClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            if (sender is DataGridView)
            {
                ...
                if (e.ColumnIndex == -1) return false;
