...
namespace DASP.ZControls
{
    ...
    /// 实现自定义效果的MessageBox
    /// </summary>
    public class ZMessageBox : FormEx
    {
        ...
        public ZMessageBox(string msgText, string caption, ZMessageBoxIcon msgBoxIcon, ZMessageBoxButtons msgBoxButtons)
        {
        ...
        public static DialogResult Show(
            ...
            string caption = "提示",
            ZMessageBoxIcon msgBoxIcon = ZMessageBoxIcon.Information,
            ZMessageBoxButtons msgBoxButtons = ZMessageBoxButtons.OK)
        {
            using (ZMessageBox msgBox = new ZMessageBox(msgText, caption, msgBoxIcon, msgBoxButtons))
            {
                if (owner != null)
                {
        ...
        private void LoadMsgBoxIcon(ZMessageBoxIcon msgBoxIcon)
        {
            switch (msgBoxIcon)
            {
                case ZMessageBoxIcon.Error:
                    _msgBoxIcon = RenderHelper.GetImageFormResourceStream("ControlEx.MessageBox.Icons.messagebox_error.png");
                    break;
                case ZMessageBoxIcon.Information:
                    _msgBoxIcon = RenderHelper.GetImageFormResourceStream("ControlEx.MessageBox.Icons.messagebox_infor.png");
                    break;
                case ZMessageBoxIcon.OK:
                    _msgBoxIcon = RenderHelper.GetImageFormResourceStream("ControlEx.MessageBox.Icons.messagebox_ok.png");
                    break;
                case ZMessageBoxIcon.Question:
                    _msgBoxIcon = RenderHelper.GetImageFormResourceStream("ControlEx.MessageBox.Icons.messagebox_question.png");
                    break;
                case ZMessageBoxIcon.Warning:
                    _msgBoxIcon = RenderHelper.GetImageFormResourceStream("ControlEx.MessageBox.Icons.messagebox_warning.png");
                    break;
                default:
                    break;
            }
        ...
        private void LoadMsgBoxButtons(ZMessageBoxButtons msgBoxButtons)
        {
