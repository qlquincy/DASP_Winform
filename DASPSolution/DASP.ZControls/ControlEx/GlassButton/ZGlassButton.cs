...
namespace DASP.ZControls
{
    ...
    /// 实现自定义效果的GlassButton
    /// </summary>
    public class ZGlassButton : PictureBox, IButtonControl
    {
        #region  Fileds
        ...
        private Image _glassHotImg = RenderHelper.GetImageFormResourceStream("ControlEx.GlassButton.Image.glassbtn_hot.png");
        private Image _glassDownImg = RenderHelper.GetImageFormResourceStream("ControlEx.GlassButton.Image.glassbtn_down.png");
