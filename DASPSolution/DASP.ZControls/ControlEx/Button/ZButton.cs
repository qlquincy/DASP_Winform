...
namespace DASP.ZControls
{
    ...
    public class ZButton : Button
    {
        ...
        private Image _normalImg = RenderHelper.GetImageFormResourceStream("ControlEx.Button.Image.btn_normal.png");
        private Image _highlightImg = RenderHelper.GetImageFormResourceStream("ControlEx.Button.Image.btn_highlight.png");
        private Image _focusImg = RenderHelper.GetImageFormResourceStream("ControlEx.Button.Image.btn_focus.png");
        private Image _downImg = RenderHelper.GetImageFormResourceStream("ControlEx.Button.Image.btn_down.png");
