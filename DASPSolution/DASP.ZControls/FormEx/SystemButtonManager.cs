...
namespace DASP.ZControls
{
    ...
    internal class SystemButtonManager : IDisposable
    {
        ...
        private void IniSystemButtons()
        {
            ...
            closeBtn.ToolTip = "关闭";
            closeBtn.NormalImg = RenderHelper.GetImageFormResourceStream("FormEx.Res.SystemButtons.close_normal.png");
            closeBtn.HighLightImg = RenderHelper.GetImageFormResourceStream("FormEx.Res.SystemButtons.close_highlight.png");
            closeBtn.DownImg = RenderHelper.GetImageFormResourceStream("FormEx.Res.SystemButtons.close_down.png");
            ...
            if (isShowMaxButton)
            {
                MaxBtn.NormalImg = RenderHelper.GetImageFormResourceStream("FormEx.Res.SystemButtons.max_normal.png");
                MaxBtn.HighLightImg = RenderHelper.GetImageFormResourceStream("FormEx.Res.SystemButtons.max_highlight.png");
                MaxBtn.DownImg = RenderHelper.GetImageFormResourceStream("FormEx.Res.SystemButtons.max_down.png");
            ...
            minBtn.NormalImg = RenderHelper.GetImageFormResourceStream("FormEx.Res.SystemButtons.min_normal.png");
            minBtn.HighLightImg = RenderHelper.GetImageFormResourceStream("FormEx.Res.SystemButtons.min_highlight.png");
            minBtn.DownImg = RenderHelper.GetImageFormResourceStream("FormEx.Res.SystemButtons.min_down.png");
